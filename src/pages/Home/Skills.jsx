...
const Skills = () => {
    return (
        <div id='skills' className="home_intro">
            <div className='home_max_width'>
                <div className='skills_inner' style={{ backgroundColor: 'var(--light)' }}>
                    <div className="skill_box">
                        <div className='skill_right'>
                            <div className="heading_size" data-aos="fade-right">
                                Skills
                            </div>

                            <span className='skill_box_span' data-aos="fade-right">
                                These are the top hirable skills i possess!
                            </span>

                            {/* <div className='skill_svg'> */}
                            {/* <svg className='skill_svg'>
                        ...
                        <div className='web_nav' >
                            <div className='skill_cardss' >
                                <div className="skill_cardss_left">
                                    <div data-aos="fade-right">
                                        <SkillCard skill='CSS' color='#2465f1' logo={cssLogo} percent={90} />
                                    </div>
                                    <div data-aos="fade-right">
                                        <SkillCard skill='HTML' color='#ff7816' logo={htmlLogo} percent={87} />
                                    </div>
                                    <div data-aos="fade-right">
                                        <SkillCard skill='Javascript' color='#d4b830' logo={jsLogo} percent={87} />
                                    </div>
                                </div>
                                <div className="skill_cardss_right">
                                    <div data-aos="fade-left">
                                        <SkillCard skill='React.js' color='#00d8ff' logo={ReactLogo} percent={86} />
                                    </div>
                                    <div data-aos="fade-left">
                                        <SkillCard skill='Next.js' color='#000000' logo={nextJs} percent={78} />
                                    </div>
                                    <div data-aos="fade-left">
                                        <SkillCard skill='Tailwind' color='#5dd4e9' logo={tailwindLogo} percent={70} />
                                    </div>
                                </div>
                            </div>
                        </div>
